                  ...
                  <div className="space-y-4">
                    ...
                    {downloadProgress === 100 && (
                      <button className="w-full py-4 bg-emerald-600 text-white rounded-2xl font-black shadow-xl hover:bg-emerald-700 transition-all flex items-center justify-center gap-2 animate-in bounce-in">
                         <Download size={20} /> Download .ZIP (2.4 MB)
                      </button>
                    )}
                  </div>
                ) : (
                ...
                <div className="space-y-1">
                  <button onClick={() => setActiveSubSetting('mobile')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 rounded-2xl transition-all group">
                    <div className="flex items-center gap-4 text-left">
                      <div className="p-2.5 bg-slate-50 group-hover:bg-white rounded-xl shadow-sm transition-colors"><Phone size={18} className="text-indigo-500" /></div>
                  ...
                  <button onClick={() => setActiveSubSetting('email')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 rounded-2xl transition-all group">
                    <div className="flex items-center gap-4 text-left">
                      <div className="p-2.5 bg-slate-50 group-hover:bg-white rounded-xl shadow-sm transition-colors"><Mail size={18} className="text-pink-500" /></div>
                  ...
                  <button onClick={() => setActiveSubSetting('download')} className="w-full flex items-center justify-between p-4 hover:bg-slate-50 rounded-2xl transition-all group">
                    <div className="flex items-center gap-4 text-left">
                      <div className="p-2.5 bg-slate-50 group-hover:bg-white rounded-xl shadow-sm transition-colors"><Download size={18} className="text-emerald-500" /></div>
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <aside className="w-64 bg-white border-r border-slate-200 p-6 flex flex-col fixed h-full">
        <div className="flex items-center gap-2 mb-10 px-2">
          ...
          <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-violet-700">
            SocialMind
          </span>
        </div>
        ...
        <div className="pt-6 mt-6 border-t border-slate-100 space-y-2">
          ...
          <button 
            ...
            className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-slate-500 hover:bg-slate-100 transition-colors"
          >
            <Instagram size={20} />
            <span className="font-medium text-sm">Switch Platform</span>
          </button>
        </div>
      </aside>
      ...
      <main className="flex-1 ml-64 p-8">
        ...
        <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
          {currentView === 'ig-dashboard' && <IGDashboard />}
